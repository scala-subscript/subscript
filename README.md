...
3. In `build.sbt`, write the following code:
  ...
  Note: you can declare a dependency on `"org.subscript-lang" %% "subscript-core" % "3.0.3"` instead of `subscript-swing`, but you need `subscript-swing` to be able to use the debugger.
...
- A larger example is our [eye test application](https://github.com/scala-subscript/eye-test).
